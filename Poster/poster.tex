...
\author{Jared Galloway$^1$, Nick Wagner$^1$, Annie Wang$^1$, Jake Searcy$^2$, Sarah Stednitz$^3$, Philip Washbourne$^4$} % Institution(s)
...
\end{alertblock}
    \begin{figure}
        \includegraphics[width=\linewidth]{zoom_fig_cropped.png}
